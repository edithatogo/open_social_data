...
- **Rust data engine swarm slice:**
    ...
    - Extracted catalog sync into reusable `sync_catalog_from_registry` and `CatalogSyncReport` library support with mock-provider source tests for metadata upserts, missing-provider errors, and explicit partial-success persistence reporting.
